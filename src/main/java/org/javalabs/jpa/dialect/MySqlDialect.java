...
public class MySqlDialect extends AbstractDBDialect {
    ...
    public String data_type(Class<?> javatype) {
        ...
        if (dbDataType == null) {
            throw new IllegalArgumentException("No mysql data type found for java type: " + javatype.getSimpleName());
        }
        return dbDataType;
    }
    ...
    public String query_tables(String schema) {
        return "SELECT table_name FROM information_schema.tables WHERE table_schema = '" + schema.toUpperCase() + "'";
    }
